...
class ElearningScreen extends StatelessWidget {
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  _buildCourseItem(
                    'Pemograman Visual Peranti Bergerak',
                  ...
                  const Divider(height: 1),
                  _buildCourseItem(
                    'Analisis Desain dan Algoritma',
                    'Dosen : Yaya Wihardi, S.Kom., M.Kom.',
                  ),
                  const Divider(height: 1),
                  _buildCourseItem(
                    'Metodologi Penelitian',
                    'Dosen : Rizky Rachman Judhie Putra, M.Kom.',
                  ),
                  const Divider(height: 1),
                  _buildCourseItem(
                    'Big Data Platform',
                    'Dosen : Prof. Dr. Lala Septem Riza, M.T.',
                  ),
                ],
              ),
            ),
  ...
  Widget _buildCourseItem(String title, String lecturer) {
    return Container(
